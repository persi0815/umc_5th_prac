...
import study.jwt.CustomAccessDeniedHandler;
import study.jwt.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    private final JwtSecurityConfig jwtSecurityConfig; //시큐리티 설정
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .authenticationEntryPoint((CustomAuthenticationEntryPoint) authenticationEntryPoint)
